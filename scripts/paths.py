...
CACHE_THREADS_DIR = os.path.join(BASE_DIR, "data", "cache_threads_gmail")
...
for _d in (PIPELINE_DIR, PAINEL_DIR, CONFIG_DIR, BACKUPS_DIR, CACHE_IMAGENS_DIR, CACHE_THREADS_DIR):
